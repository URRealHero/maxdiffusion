...
def train(config):
  from maxdiffusion.trainers.wan_2_2_dense_frame_concat_lora_trainer import Wan2_2DenseFrameConcatLoRATrainer

  trainer = Wan2_2DenseFrameConcatLoRATrainer(config)
